...
def create_defect_files(atom_lines, footer_lines, mg_atoms, o_core_atoms, o_shel_atoms, max_iterations=5):
    ...
    for iteration in range(1, max_iterations + 1):
        ...
        # Update the footer to include the new line
...
# Parse the file and filter atom types
atom_lines_coords, footer_lines_coords = parse_gulp_file_coordinates(file_path)
mg_core_atoms = filter_atom_type_strict(atom_lines_coords, "Mg core")
o_core_atoms = filter_atom_type_strict(atom_lines_coords, "O core")
o_shel_atoms = filter_atom_type_strict(atom_lines_coords, "O shel")

# Create defect files
create_defect_files(atom_lines_coords, footer_lines_coords, mg_core_atoms, o_core_atoms, o_shel_atoms)
